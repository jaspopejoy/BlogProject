...
namespace BlogProject.Controllers
{
    public class CommentsController : Controller
    {
        ...
        // GET: Comments
        public async Task<IActionResult> OrigionalIndex()
        {
            var origionalComments = await _context.Comments.ToListAsync();
            return View("Index", origionalComments );
        }

        public async Task<IActionResult> ModeratedIndex()
        {
            var origionalComments = await _context.Comments.Where(c => c.Moderated !=null).ToListAsync();
            return View("Index", origionalComments);
        }

        //public async Task<IActionResult> ModeratedIndex()
        //{
          //Use sort delete bool          
        //}
